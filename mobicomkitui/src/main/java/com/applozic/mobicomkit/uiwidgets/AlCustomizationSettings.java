...
public class AlCustomizationSettings extends JsonMarker {
    ...
    private String sendButtonBackgroundColor = "#F0F0F0F0";
    private String attachmentIconsBackgroundColor = "#555555";
    ...
    private String themeColorPrimary="#f1f1f1";
    private String themeColorPrimaryDark="#aeaeae";
