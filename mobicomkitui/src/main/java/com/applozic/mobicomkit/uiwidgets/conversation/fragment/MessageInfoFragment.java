...
public class MessageInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ConversationActivity.infoFragmentbackstack=1;
        return view;
    }
    ...
    private void init() {
        ...
        TextView titleview= (TextView) toolbar.findViewById(R.id.my_toolbar_title);
        titleview.setText("View History");
        ImageView infoIcon=(ImageView)toolbar.findViewById(R.id.iv_businessInfo);
