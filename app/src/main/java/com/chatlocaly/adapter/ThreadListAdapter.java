...
public class ThreadListAdapter extends RecyclerView.Adapter<ThreadListAdapter.ViewHolder> {
    ...
    private ThreadesFragment threadesFragment;
    private String bussinessName;

    public ThreadListAdapter(Context context, List<ThreadModel.Datadata.MessageListdata> list, ThreadesFragment threadesFragment) {
        ...
        this.threadesFragment = threadesFragment;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tv_storetitle.setInputType(InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
      ...
      //  MainActivity.setThreadTabCount(new MessageDatabaseService(context).getUnreadConversationCount());


        ThreadesFragment.upMessageCounter(context);
    ...
    public void notify(List<ThreadModel.Datadata.MessageListdata> list) {
        ...
        if(ThreadesFragment.iv_tag!=null)
        {
            if(list.size()>0)
                ...
                ThreadesFragment.iv_tag.setVisibility(View.VISIBLE);
     ...
     */               }
        ...
        public void onCreateContextMenu(final ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
            ...
            contextMenu.add("Remove").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
               ...
               {
                   Utill.showCenteredToast(context,"Please Untag business to remove it.");

               }
               else {
                   MobiComMessageService.chatUpdateTag = 1;
                   threadesFragment.setBlockBusiness(chatlocalyshareprefrence.getEncryptKey(), chatlocalyshareprefrence.getUserId(), Constant.REMOVE_BUSINESS, messageListdata.getbId(), messageListdata.getChatGroupId(), getAdapterPosition());
               }
                ...
                if (list.get(getAdapterPosition()).getBlock_chat_group().equalsIgnoreCase("1")) {
                    contextMenu.add("Unblock").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            ...
                            // for tag list update
                            MobiComMessageService.chatUpdateTag = 1;
                            threadesFragment.setBlockBusiness(chatlocalyshareprefrence.getEncryptKey(), chatlocalyshareprefrence.getUserId(), Constant.UNBLOCK_BUSINESS, messageListdata.getbId(), messageListdata.getChatGroupId(), getAdapterPosition());
                    ...
                    contextMenu.add("Block").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            // for tag list update
                            MobiComMessageService.chatUpdateTag = 1;
                            threadesFragment.setBlockBusiness(chatlocalyshareprefrence.getEncryptKey(), chatlocalyshareprefrence.getUserId(), Constant.BLOCK_BUSINESS, messageListdata.getbId(), messageListdata.getChatGroupId(), getAdapterPosition());
                ...
                if (list.get(getAdapterPosition()).getCustomer_tag().equalsIgnoreCase("1")) {
                    contextMenu.add("Untag").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            ...
                            MobiComMessageService.chatUpdateTag = 1;
                            threadesFragment.setTagBusiness(chatlocalyshareprefrence.getEncryptKey(), chatlocalyshareprefrence.getUserId(), Constant.UNTAG, list.get(getAdapterPosition()).getbId(), getAdapterPosition());
                    ...
                    contextMenu.add("Tag").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            ...
                            // for tag list update
                            MobiComMessageService.chatUpdateTag = 1;
                            threadesFragment.setTagBusiness(chatlocalyshareprefrence.getEncryptKey(), chatlocalyshareprefrence.getUserId(), Constant.TAG, list.get(getAdapterPosition()).getbId(), getAdapterPosition());
                ...
                if (list.get(getAdapterPosition()).getCustomer_notification().equalsIgnoreCase("1")) {
                    ...
                    contextMenu.add("Unmute").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            // for tag list update
                            MobiComMessageService.chatUpdateTag = 1;
                            threadesFragment.umuteGroupChat(list.get(getAdapterPosition()).getGroupId(),""+messageListdata.getbId(),getAdapterPosition());
                    ...
                    contextMenu.add("Mute").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            ...
                            threadesFragment.muteGroupChat(list.get(getAdapterPosition()).getGroupId(),messageListdata.getbId(),getAdapterPosition());
            ...
            else
            {
                ...
                if(list.get(getAdapterPosition()).getBlock_side().equalsIgnoreCase("customer") || list.get(getAdapterPosition()).getBlock_side().equalsIgnoreCase("")  ) {
      ...
      /*  ThreadModel.Datadata.MessageListdata messageListdata=list.get(getAdapterPosition());
          // for tag list update
        MobiComMessageService.chatUpdateTag=1;
...
/*********************** ***************0***/
            tv_unblock.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    MobiComMessageService.chatUpdateTag = 1;
                    threadesFragment.setBlockBusiness(chatlocalyshareprefrence.getEncryptKey(), chatlocalyshareprefrence.getUserId(), Constant.UNBLOCK_BUSINESS, bId, chatGroupId,position);
                    dialog.dismiss();
                }
            });
