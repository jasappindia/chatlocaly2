...
public class ServiceDetailsModel {
    ...
    public static class Datadata {
        ...
        private List<ServiceModel.Datadata.ServiceListdata> businessDetail;
        ...
        public List<ServiceModel.Datadata.ServiceListdata> getBusinessDetail() {
            return businessDetail;
        }

        public void setBusinessDetail(List<ServiceModel.Datadata.ServiceListdata> businessDetail) {
